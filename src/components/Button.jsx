...
const Button = ({ 
  ...
  const baseStyles = "font-medium py-2 px-6 transition-all duration-300 active:scale-95 flex items-center justify-center text-center";
  ...
  const variantStyles = {
    ...
    outlineGreen: "border-2 border-iroko text-iroko bg-transparent hover:bg-transparent hover:border-iroko-hover active:border-iroko-pressed active:text-iroko-pressed hover:text-iroko-hover shadow-sm",

    // Bordered White
    outlineWhite: "border-2 border-gray-300 text-gray-300 bg-transparent hover:border-white hover:text-white shadow-sm",
